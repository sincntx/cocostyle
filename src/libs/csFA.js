var csFA = cc.LabelTTF.extend({
    ctor: function (text, fontSize, color) {
        var fontDef = new cc.FontDefinition();

        if(!color) {
            color = csFA.color.white;
        }

        fontDef.fontName = csFA.fontName;
        fontDef.fontSize = fontSize;
        fontDef.textAlign = cc.TEXT_ALIGNMENT_CENTER;
        fontDef.verticalAlign = cc.VERTICAL_TEXT_ALIGNMENT_CENTER;
        fontDef.fillStyle = color;
        text = ' ' + text + ' ';
        cc.LabelTTF.prototype.ctor.call(this, text, fontDef);
    },
...
csFA.fontName = 'FontAwesome';

csFA.icon = function (str) {
    var icons = {
        "fa-adjust": "0xf042",
        "fa-adn": "0xf170",
    ...
    return csFA.ucs2encode([eval(icons[str])]);
};

csFA.ucs2encode = function(array) {
    return csFA.map(array, function(value) {
        var output = '';
        if (value > 0xFFFF) {
            value -= 0x10000;
...
csFA.color = {transparent:cc.color(255,255,255,255), white:cc.color(255,255,255,255), black:cc.color(0,0,0,255), grey:cc.color(100,100,100,255), blue:cc.color(0,161,203,255), green:cc.color(148,193,46,255),orange:cc.color(241,141,5,255),red:cc.color(229,64,40,255),purple:cc.color(135,49,140,255)};
