var csLabelTTFExtTestLayer = cc.Layer.extend({
    ctor:function () {
        var winSize;
        var toast;
        ...
        title = cc.LabelTTF.create("Cocostyle Label TTF Ext Test", "Arial", 20);
...
var csLabelTTFExtTestScene = cc.Scene.extend({
    onEnter:function () {
        this._super();
        var layer = new csLabelTTFExtTestLayer();
        this.addChild(layer);
    }
});
